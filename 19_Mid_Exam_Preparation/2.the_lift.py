def lift_func(waiting_people, current_state_of_lift):
    for i in range(len(current_state_of_lift)):
        if waiting_people > 3:
            current_number_of_people = abs(4 - int(current_state_of_lift[i]))
            waiting_people -= current_number_of_people
            current_state_of_lift[i] += current_number_of_people
        else:
...
# def lift_func(waiting_people, current_state_of_lift):
#     for i in range(len(current_state_of_lift)):                                     *BR
#         if waiting_people > 3:
#             current_number_of_people = abs(4 - int(current_state_of_lift[i]))
#             waiting_people -= current_number_of_people
#             current_state_of_lift[i] += current_number_of_people
...
#
# number_of_people = int(input())
# lift_condition = list(map(int, input().split(" ")))                                *BR
# lift_func(number_of_people, lift_condition)                                        *BR